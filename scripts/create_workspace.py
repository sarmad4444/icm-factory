...
def get_telemetry_snippet(style: str) -> str:
    """Returns the mandatory Layer 0 response telemetry protocol snippet for the specified style."""
    if style == "pill-bar":
        return (
            "\n---\n\n"
        ...
        return (
            "\n---\n\n"
            "## 1. Mandatory Response Telemetry Protocol (Layer 0 Invariant)\n\n"
            "**Every response generated by any AI CLI MUST dynamically re-evaluate and prepend the following Cyberpunk Terminal Box header at the very top of EVERY turn before any prose, code, or explanation. Stale or copied values are strictly forbidden.**\n\n"
            "```text\n"
        ...
        return (
            "\n---\n\n"
            "## 1. Mandatory Response Telemetry Protocol (Layer 0 Invariant)\n\n"
            "**Every response generated by any AI CLI MUST dynamically re-evaluate and prepend the following Cockpit HUD header at the very top of EVERY turn before any prose, code, or explanation. Stale or copied values are strictly forbidden.**\n\n"
        ...
        return (
            "\n---\n\n"
            "## 1. Mandatory Response Telemetry Protocol (Layer 0 Invariant)\n\n"
            "**Every response generated by any AI CLI MUST dynamically re-evaluate and prepend the following Monospace Grid header at the very top of EVERY turn before any prose, code, or explanation. Stale or copied values are strictly forbidden.**\n\n"
            "`[Agent: @[Agent]] [Skills: [skills]] [Grounding: [Verified | Grounded | Design]]`  \n"
            "`[Confidence: [XX%]] [Context: [~X.Xk / 200k]] [Tokens: [~XXX]]`  \n"
            "`[Workflow: [stage]] [Sprint: [Phase/Task]] [Refs: [files]]`\n"
        )
        ...
        return (
            "\n---\n\n"
            "## 1. Mandatory Response Telemetry Protocol (Layer 0 Invariant)\n\n"
            "**Every response generated by any AI CLI MUST dynamically re-evaluate and prepend the following Micro-Table header at the very top of EVERY turn before any prose, code, or explanation. Stale or copied values are strictly forbidden.**\n\n"
...
"""
    ...
    if telemetry_header:
        ...
        if len(parts) == 2:
            agent_content = parts[0] + telemetry_header + "\n---\n" + parts[1]
        else:
